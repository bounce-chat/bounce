...
func TestCanRenameGroupAndConfirm(t *testing.T) {
	...
	awaitDelivery(t, b, typeConfirmation, ac.ID)
	awaitDelivery(t, b, typeConfirmation, bc.ID)
	...
	awaitDelivery(t, alice, typeConfirmation, bc.ID)
	var aug updateGroup
	...
	awaitDelivery(t, bob, typeConfirmation, ac.ID)
	var bug updateGroup
