...
type Bounce struct {
	...
	postNotification      func(string, string, string)
...
func Open(ui UI, network Network, configDirectory string, postNotification func(id, title, content string), clearNotification func(string)) Engine {
